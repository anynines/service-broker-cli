...
func registerCommands() {
	...
	addCommand("target", "t", "Set or view the targeted organization and space", sbcli.Target)
	...
	addCommand("", "", "", nil)
	addCommand("create-org", "co", "No-op logger, provided for cf CLI compatibility", sbcli.CreateOrg)
	addCommand("create-space", "csp", "No-op logger, provided for cf CLI compatibility", sbcli.CreateSpace)
	addCommand("", "", "", nil)
